function bedpostx_pdf_path = bedpostx_plot(job_dir,dwmri_file,mask_file,mean_fsumsamples_file,dyads_files,meanfsamples_files,fsl_path,bedpostx_name,bedpostx_params,num_fibres)
    ...
    f = dwmri_axial_coronal_plot(dv, ...
                                 {'BedpostX', ...
                                 ['   FSL path: ' fsl_path ], ...
                                 ['   bedpostx executable: ' bedpostx_name], ...
